...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    ...
    */
    $sql="INSERT INTO parent (ID, FullName,Username,`Password`,`Message`, Phonenum, Patient_ID)".
    "VALUES (NULL,'$FullName','$Username','$Password','', '$Phonenum','$Patient_ID')";
...
<input  type="submit" value="Add Parent" name="submit">
